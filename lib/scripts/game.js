...
function splashMsg(closeness, msg) {
  ...
  jQuery(splashText).text(msg).finish().removeClass().addClass(splashTextModifierClass).fadeIn(1000).delay(2000).fadeOut(1000);
}
...
function updatePlayerPosition(row, col) {
  var isOpponentMove = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
